...
public class DebugDraw {
  ...
  public static void start() {
    ...
    // Enable the vertexArray Attributes
  ...
  private static void rotate(Vector2f vert, float angle, Vector2f center) {
    ...
    vert.x = x * cos - y * sin + center.x;
    vert.y = x * sin + y * cos + center.y;
  }
  ...
  public static void addCircle(Vector2f center, float radius, Vector3f color, int lifetime) {
    ...
    for (int i = 0; i < points.length; i++) {
      ...
      rotate(temp, currentAngle, new Vector2f());
