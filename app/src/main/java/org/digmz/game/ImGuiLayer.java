...
public class ImGuiLayer {
  ...
  public void initImGui() {
    ...
    float sizeFont = (float) Math.min(Window.getWidth(), Window.getHeight()) / 60.0f;
    // Fonts merge example
    fontConfig.setPixelSnapH(true);
    fontAtlas.addFontFromFileTTF("assets/fonts/segoe-ui-4-cufonfonts/Segoe UI.ttf", sizeFont);
